...
class ProductService extends Loblaws implements ProductRequestInterface {

    public function request_product($site_product_id, $site_store_id, $banner = 'superstore'){
    ...
    public function create_image($name, $url, $size): ?string {
        return $this->image_service->save($name, $url, $size, 'products', $this->company_name);
    }
